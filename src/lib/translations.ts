...
export const translations = {
  en: {
    ...
    // Path Selection
    "paths.building": "Building Your Journey",
    "paths.designing": "Our AI is designing a practical, step-by-step roadmap for your selected career path.",
    "paths.drafting": "Drafting Module...",
    "paths.finding": "Finding best paths...",
    "paths.mapping": "Mapping your skills to career opportunities in your area.",
    "paths.choose": "Choose Your Path",
    "paths.tailored": "Three career paths tailored to your profile and local market data.",
    "paths.bestMatch": "Best Match",
    "paths.goodMatch": "Good Match",
    "paths.income": "Est. Income",
    "paths.duration": "Duration",
    "paths.weeks": "weeks",
    "paths.preview": "Curriculum Preview",
    ...
    "features.engine.desc": "Bayesian Knowledge Tracing monitors your mastery in real-time, dynamically adjusting task difficulty.",
    "features.market.title": "Market Intelligence",
    "features.market.desc": "Real-time job demand data for your region.",
    "features.multi.title": "Multilingual",
    "features.multi.desc": "English, Hindi, Kannada",
    "features.mentor.title": "AI Mentor",
    "features.mentor.desc": "Context-aware guidance",
    "cta.final.title": "Ready to start learning?",
    "cta.final.desc": "Join thousands of others building their future with adaptive AI learning.",

    // Profile Page
    "profile.level": "Level",
    "profile.localHub": "Local Hub",
    "profile.activeMode": "Active Learning Mode",
    "profile.editIntel": "Edit Intel",
    "profile.exportCV": "Export CV",
    "profile.readinessScore": "Career Readiness Score",
    "profile.outperforming": "You are outperforming",
    "profile.ofApplicants": "of applicants in your target market.",
    "profile.trainingModules": "Training Modules",
    "profile.roadmapProgress": "Roadmap Progress",
    "profile.completeCount": "complete",
    "profile.milestonesHit": "Milestones Hit",
    "profile.skillMatrix": "Skill Matrix",
    "profile.proficiencyTrace": "Real-time Proficiency Trace",
    "profile.currentObjective": "Current Objective",
    "profile.continueJourney": "Continue Your Learning Journey",
    "profile.workingOnModule": "You are currently working on Module",
    "profile.boostScore": "Completion will boost your Capability Score.",
    "profile.continueTraining": "Continue Training",
    "profile.marketInsights": "Market Insights",
    "profile.recentMilestones": "Recent Milestones",
    "profile.matchedRoles": "Matched Roles",
    "profile.opsInArea": "Opportunities in your area",
    "profile.notReady": "Profile Not Ready",
    ...
    "analytics.calibration": "Calibration required: Complete your first module to see your curve.",
    "analytics.breakdown": "Detailed Breakdown",
    "analytics.kcs": "Knowledge Components",
    "analytics.distribution": "Mastery Distribution",
    "analytics.mastered": "Mastered",
    "analytics.zpd": "Active ZPD",
    "analytics.needsReview": "Needs Review",
    "analytics.sdg8": "SDG 8 Outcomes",
    "analytics.jobSecured": "Job/Gig Secured",
    ...
    "jobs.findOps": "Find opportunities",
    "jobs.found": "Found",
    "jobs.roleSkill": "Role or skill...",
    "jobs.city": "City...",
    "jobs.search": "Search",
    "jobs.searching": "Searching...",
    "jobs.searchPrompt": "Search for jobs",
    "jobs.searchDesc": "Enter a role and city to find opportunities.",
    "jobs.remote": "Remote",
    "jobs.results": "results",

    // Badges
    "badges.pursuing": "Pursuing",
    ...
    "hero.ctaLoggedIn": "Resume Learning",
    ...
    "q9.opt2": "Hindi",
    "q9.opt3": "Kannada",
    "q10.opt1": "1 — I find it very difficult",
    "q10.opt2": "2 — I can do basic things (calls, WhatsApp)",
    "q10.opt3": "3 — I can use most apps comfortably",
    "q10.opt4": "4 — I am fairly confident with technology",
  ...
  hi: {
    ...
    "paths.choose": "अपना रास्ता चुनें",
    "paths.tailored": "आपके प्रोफाइल और स्थानीय बाजार डेटा के अनुरूप तीन करियर पथ।",
    "paths.bestMatch": "सबसे अच्छा मिलान",
    "paths.goodMatch": "अच्छा मिलान",
    "paths.income": "अनुमानित आय",
    "paths.duration": "अवधि",
    "paths.weeks": "हफ्ते",
    "paths.preview": "पाठ्यक्रम पूर्वावलोकन",
    ...
    "features.market.desc": "आपके क्षेत्र के लिए वास्तविक समय में नौकरियों की मांग का डेटा।",
    "features.multi.title": "बहुभाषी",
    "features.multi.desc": "अंग्रेजी, हिंदी, कन्नड़",
    "features.mentor.title": "एआई मेंटर",
    "features.mentor.desc": "संदर्भ-जागरूक मार्गदर्शन",
    ...
    "profile.editIntel": "जानकारी संपादित करें",
    "profile.exportCV": "सीवी निर्यात करें",
    "profile.readinessScore": "करियर तैयारी स्कोर",
    "profile.outperforming": "आप बेहतर प्रदर्शन कर रहे हैं",
    "profile.ofApplicants": "आपके लक्षित बाजार के आवेदकों से।",
    "profile.trainingModules": "प्रशिक्षण मॉड्यूल",
    "profile.roadmapProgress": "रोडमैप प्रगति",
    "profile.completeCount": "पूरा",
    "profile.milestonesHit": "मील के पत्थर",
    "profile.skillMatrix": "कौशल मैट्रिक्स",
    "profile.proficiencyTrace": "वास्तविक समय प्रवीणता ट्रेस",
    "profile.currentObjective": "वर्तमान लक्ष्य",
    "profile.continueJourney": "अपनी सीखने की यात्रा जारी रखें",
    "profile.workingOnModule": "आप वर्तमान में मॉड्यूल पर काम कर रहे हैं",
    "profile.boostScore": "पूरा होने से आपकी क्षमता स्कोर बढ़ेगी।",
    "profile.continueTraining": "प्रशिक्षण जारी रखें",
    "profile.marketInsights": "बाजार अंतर्दृष्टि",
    "profile.recentMilestones": "हाल के मील के पत्थर",
    ...
    "analytics.learningCurve": "सीखने की अवस्था",
    "analytics.calibration": "कैलिब्रेशन आवश्यक: अपना कर्व देखने के लिए अपना पहला मॉड्यूल पूरा करें।",
    "analytics.breakdown": "विस्तृत विवरण",
    "analytics.kcs": "ज्ञान घटक",
    "analytics.distribution": "महारत वितरण",
    "analytics.mastered": "महारत हासिल",
    "analytics.zpd": "सक्रिय ज़ेडपीडी",
    "analytics.needsReview": "समीक्षा की आवश्यकता",
    "analytics.sdg8": "एसडीजी 8 परिणाम",
    "analytics.jobSecured": "नौकरी/गिग सुरक्षित",
    ...
    "analytics.aiAnalysis": "एआई विश्लेषण",
    ...
    "jobs.found": "मिले",
    "jobs.roleSkill": "भूमिका या कौशल...",
    "jobs.city": "शहर...",
    "jobs.search": "खोजें",
    "jobs.searching": "खोजा जा रहा है...",
    "jobs.searchPrompt": "नौकरियों के लिए खोजें",
    "jobs.searchDesc": "अवसर खोजने के लिए भूमिका और शहर दर्ज करें।",
    "jobs.remote": "रिमोट",
    "jobs.results": "परिणाम",
    ...
    "hero.ctaLoggedIn": "सीखना जारी रखें",
    ...
    "q9.opt2": "हिंदी",
    "q9.opt3": "कन्नड़",
    "q10.opt1": "1 — मुझे यह बहुत कठिन लगता है",
    "q10.opt2": "2 — मैं बुनियादी चीजें कर सकता हूं (कॉल, व्हाट्सएप)",
    "q10.opt3": "3 — मैं अधिकांश ऐप्स का आसानी से उपयोग कर सकता हूं",
    "q10.opt4": "4 — मैं तकनीक के साथ काफी आश्वस्त हूं",
    "q10.opt5": "5 — मैं विशेषज्ञ हूं / बहुत आश्वस्त हूं",
  },
  kn: {
    ...
    "paths.building": "ನಿಮ್ಮ ಪ್ರಯಾಣದ ನಿರ್ಮಾಣ",
    "paths.designing": "ನಮ್ಮ AI ನೀವು ಆಯ್ಕೆ ಮಾಡಿದ ವೃತ್ತಿಜೀವನದ ಹಾದಿಗಾಗಿ ಪ್ರಾಯೋಗಿಕ, ಹಂತ-ಹಂತದ ಮಾರ್ಗಸೂಚಿಯನ್ನು ವಿನ್ಯಾಸಗೊಳಿಸುತ್ತಿದೆ.",
    "paths.drafting": "ಮಾಡ್ಯೂಲ್ ಸಿದ್ಧಪಡಿಸಲಾಗುತ್ತಿದೆ...",
    "paths.finding": "ಅತ್ಯುತ್ತಮ ಮಾರ್ಗಗಳನ್ನು ಹುಡುಕಲಾಗುತ್ತಿದೆ...",
    "paths.mapping": "ನಿಮ್ಮ ಪ್ರದೇಶದಲ್ಲಿನ ವೃತ್ತಿ ಅವಕಾಶಗಳಿಗೆ ನಿಮ್ಮ ಕೌಶಲ್ಯಗಳನ್ನು ಮ್ಯಾಪಿಂಗ್ ಮಾಡಲಾಗುತ್ತಿದೆ.",
    "paths.choose": "ನಿಮ್ಮ ಹಾದಿಯನ್ನು ಆಯ್ಕೆಮಾಡಿ",
    "paths.tailored": "ನಿಮ್ಮ ಪ್ರೊಫೈಲ್ ಮತ್ತು ಸ್ಥಳೀಯ ಮಾರುಕಟ್ಟೆ ಡೇಟಾಗೆ ಅನುಗುಣವಾಗಿ ಮೂರು ವೃತ್ತಿಜೀವನದ ಮಾರ್ಗಗಳು.",
    "paths.bestMatch": "ಅತ್ಯುತ್ತಮ ಹೊಂದಾಣಿಕೆ",
    "paths.goodMatch": "ಉತ್ತಮ ಹೊಂದಾಣಿಕೆ",
    "paths.income": "ಅಂದಾಜು ಆದಾಯ",
    "paths.duration": "ಅವಧಿ",
    "paths.weeks": "ವಾರಗಳು",
    "paths.preview": "ಪಠ್ಯಕ್ರಮದ ಮುನ್ನೋಟ",
    ...
    "features.multi.desc": "ಇಂಗ್ಲಿಷ್, ಹಿಂದಿ, ಕನ್ನಡ",
    "features.mentor.title": "AI ಮಾರ್ಗದರ್ಶಕ",
    "features.mentor.desc": "ಸಂದರ್ಭ-ಅರಿವಿನ ಮಾರ್ಗದರ್ಶನ",
    ...
    "profile.editIntel": "ಮಾಹಿತಿ ಸಂಪಾದಿಸಿ",
    "profile.exportCV": "CV ರಫ್ತು ಮಾಡಿ",
    "profile.readinessScore": "ವೃತ್ತಿ ಸಿದ್ಧತೆಯ ಸ್ಕೋರ್",
    "profile.outperforming": "ನೀವು ಉತ್ತಮವಾಗಿ ಪ್ರದರ್ಶನ ನೀಡುತ್ತಿದ್ದೀರಿ",
    "profile.ofApplicants": "ನಿಮ್ಮ ಗುರಿ ಮಾರುಕಟ್ಟೆಯಲ್ಲಿನ ಅರ್ಜಿದಾರರಿಗಿಂತ.",
    "profile.trainingModules": "ತರಬೇತಿ ಮಾಡ್ಯೂಲ್‌ಗಳು",
    "profile.roadmapProgress": "ಮಾರ್ಗಸೂಚಿ ಪ್ರಗತಿ",
    "profile.completeCount": "ಪೂರ್ಣಗೊಂಡಿದೆ",
    "profile.milestonesHit": "ಮೈಲಿಗಲ್ಲುಗಳು",
    "profile.skillMatrix": "ಕೌಶಲ್ಯ ಮ್ಯಾಟ್ರಿಕ್ಸ್",
    "profile.proficiencyTrace": "ನೈಜ-ಸಮಯದ ಪ್ರಾವೀಣ್ಯತೆ ಟ್ರೇಸ್",
    "profile.currentObjective": "ಪ್ರಸ್ತುತ ಗುರಿ",
    "profile.continueJourney": "ನಿಮ್ಮ ಕಲಿಕೆಯ ಪ್ರಯಾಣವನ್ನು ಮುಂದುವರಿಸಿ",
    "profile.workingOnModule": "ನೀವು ಪ್ರಸ್ತುತ ಮಾಡ್ಯೂಲ್‌ನಲ್ಲಿ ಕೆಲಸ ಮಾಡುತ್ತಿದ್ದೀರಿ",
    "profile.boostScore": "ಪೂರ್ಣಗೊಳಿಸುವಿಕೆಯು ನಿಮ್ಮ ಸಾಮರ್ಥ್ಯದ ಸ್ಕೋರ್ ಅನ್ನು ಹೆಚ್ಚಿಸುತ್ತದೆ.",
    "profile.continueTraining": "ತರಬೇತಿಯನ್ನು ಮುಂದುವರಿಸಿ",
    "profile.marketInsights": "ಮಾರುಕಟ್ಟೆ ಒಳನೋಟಗಳು",
    "profile.recentMilestones": "ಇತ್ತೀಚಿನ ಮೈಲಿಗಲ್ಲುಗಳು",
    "profile.matchedRoles": "ಹೊಂದಾಣಿಕೆಯ ಪಾತ್ರಗಳು",
    "profile.opsInArea": "ನಿಮ್ಮ ಪ್ರದೇಶದಲ್ಲಿನ ಅವಕಾಶಗಳು",
    "profile.notReady": "ಪ್ರೊಫೈಲ್ ಸಿದ್ಧವಾಗಿಲ್ಲ",
    ...
    "analytics.learningCurve": "ಕಲಿಕೆಯ ವಕ್ರರೇಖೆ",
    "analytics.calibration": "ಮಾಪನಾಂಕ ನಿರ್ಣಯ ಅಗತ್ಯವಿದೆ: ನಿಮ್ಮ ವಕ್ರರೇಖೆಯನ್ನು ನೋಡಲು ನಿಮ್ಮ ಮೊದಲ ಮಾಡ್ಯೂಲ್ ಅನ್ನು ಪೂರ್ಣಗೊಳಿಸಿ.",
    "analytics.breakdown": "ವಿವರವಾದ ಸ್ಥಗಿತ",
    "analytics.kcs": "ಜ್ಞಾನದ ಘಟಕಗಳು",
    "analytics.distribution": "ಪಾಂಡಿತ್ಯ ವಿತರಣೆ",
    "analytics.mastered": "ಪಾಂಡಿತ್ಯ ಸಾಧಿಸಲಾಗಿದೆ",
    "analytics.zpd": "ಸಕ್ರಿಯ ZPD",
    "analytics.needsReview": "ಪರಿಶೀಲನೆಯ ಅಗತ್ಯವಿದೆ",
    "analytics.sdg8": "SDG 8 ಫಲಿತಾಂಶಗಳು",
    "analytics.jobSecured": "ಉದ್ಯೋಗ/ಗಿಗ್ ಸುರಕ್ಷಿತ",
    ...
    "analytics.aiAnalysis": "AI ವಿಶ್ಲೇಷಣೆ",
    ...
    "jobs.found": "ಸಿಕ್ಕಿದೆ",
    "jobs.roleSkill": "ಪಾತ್ರ ಅಥವಾ ಕೌಶಲ್ಯ...",
    "jobs.city": "ನಗರ...",
    "jobs.search": "ಹುಡುಕಿ",
    "jobs.searching": "ಹುಡುಕಲಾಗುತ್ತಿದೆ...",
    "jobs.searchPrompt": "ಕೆಲಸಗಳಿಗಾಗಿ ಹುಡುಕಿ",
    "jobs.searchDesc": "ಅವಕಾಶಗಳನ್ನು ಹುಡುಕಲು ಪಾತ್ರ ಮತ್ತು ನಗರವನ್ನು ನಮೂದಿಸಿ.",
    ...
    "hero.ctaLoggedIn": "ಕಲಿಕೆಯನ್ನು ಮುಂದುವರಿಸಿ",
    ...
    "q9.opt2": "ಹಿಂದಿ",
    "q9.opt3": "ಕನ್ನಡ",
    "q10.opt1": "1 - ನನಗೆ ಇದು ತುಂಬಾ ಕಷ್ಟ ಅನಿಸುತ್ತದೆ",
    "q10.opt2": "2 - ನಾನು ಮೂಲಭೂತ ಕೆಲಸಗಳನ್ನು ಮಾಡಬಲ್ಲೆ (ಕರೆಗಳು, ವಾಟ್ಸಾಪ್)",
    "q10.opt3": "3 - ನಾನು ಹೆಚ್ಚಿನ ಅಪ್ಲಿಕೇಶನ್‌ಗಳನ್ನು ಸುಲಭವಾಗಿ ಬಳಸಬಲ್ಲೆ",
    "q10.opt4": "4 - ನಾನು ತಂತ್ರಜ್ಞಾನದ ಬಗ್ಗೆ ಸಾಕಷ್ಟು ವಿಶ್ವಾಸ ಹೊಂದಿದ್ದೇನೆ",
    "q10.opt5": "5 - ನಾನು ತಜ್ಞ / ತುಂಬಾ ವಿಶ್ವಾಸ ಹೊಂದಿದ್ದೇನೆ",
  }
};
